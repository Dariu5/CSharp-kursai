...
namespace _27_2_sensors
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="sensors")]
    ...
    partial void DeleteMeasurement(Measurement instance);
		...
		public ConverterDataContext() : 
				base(global::_27_2_sensors.Properties.Settings.Default.sensorsConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class Sensor : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<System.DateTime> _DateOfRecrd;
    ...
    partial void OnDateOfRecrdChanging(System.Nullable<System.DateTime> value);
    partial void OnDateOfRecrdChanged();
    ...
    partial void OnSVChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DateOfRecrd", DbType="DateTime")]
		public System.Nullable<System.DateTime> DateOfRecrd
		{
			get
			{
				return this._DateOfRecrd;
			}
			set
			{
				if ((this._DateOfRecrd != value))
				{
					this.OnDateOfRecrdChanging(value);
					this.SendPropertyChanging();
					this._DateOfRecrd = value;
					this.SendPropertyChanged("DateOfRecrd");
					this.OnDateOfRecrdChanged();
				}
			}
		}
